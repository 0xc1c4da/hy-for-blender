bl_info = {
    ...
    "version": (0, 1),
    "blender": (2, 7, 0),
    "location": "Console > Languages... > Hy",
    "description": "Hy for Blender",
    "warning": "",
    "wiki_url": "",
    "tracker_url": "",
    "category": "Language"}
...
# monkey patch the console_hylang name, to be loaded by lines 86-90 of scripts/startup/bl_ui/space_console.py
if __name__ != "console_hy":
    sys.modules["console_hy"] = sys.modules[__name__]


def register():
    print("** version: ", bl_info['version'], " **")
    print("** Have a nice day with Hy  **\n")
...
def get_console(console_id):
    ...
    if console_data:
        ...
        console = HyREPL(locals=namespace,
...
def banner(context):
    ...
    hyblend_version = '.'.join(map(str, bl_info['version']))

    add_scrollback("Hy for Blender %s (Hy %s, Python %s)" % (hyblend_version, hy.__version__, version_string), 'OUTPUT')
